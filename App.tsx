  ...
  const renderContent = () => {
    ...
    switch (view) {
      ...
      default:
        return (
          <>
            <DashboardHeader title={t('appName')} showSpecialConditionIcon={showSpecialConditionIcon} specialConditionTooltip={t('specialConditionActive')} />
            <Dashboard currentUser={currentUser} setView={handleSetView} setModalContent={setModalContent} summaryTimeFrame={summaryTimeFrame} isAiEnabled={isAiEnabled} isEstimating={isEstimating} lastPrediction={lastPrediction} lastComparison={lastComparison} onEstimate={handleEstimate} onStartComparison={handleStartComparison} t={t} language={language} />
          </>
        );
    }
  };
